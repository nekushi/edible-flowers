              ...
              <article className="overflow-hidden rounded-2xl border border-blossom-200 bg-white shadow-md">
                <div className="grid items-center gap-0 lg:grid-cols-2">
                  <div className="relative aspect-4/3 lg:aspect-auto lg:min-h-[22rem]">
                    <Image
                      src="/edible-flowers/sample-product-1.jpg"
                      alt="Rose Garden Cupcakes — newest creation"
                      fill
                  ...
                  <div className="p-6 sm:p-8 lg:p-10">
                    ...
                    <p className="mt-4 leading-relaxed text-cocoa-600">
                      Delicate buttercream roses atop vanilla cupcakes — our
                      latest handcrafted design, perfect for celebrations and
                      special occasions.
                    </p>
                    <Link
                      href="#contact"
